...
SOURCES            = main.c myLib.c splash.c pause.c lose.c win.c gameBG1.c gameBG2.c sprites.c instructions.c OnikuLoop.c NoMonkey.c levelup.c wechampions.c explosion.c OhGod.c
DKPATH             = /Users/danielansher/Documents/devkitARM/bin
CCPATH             = /usr/bin
VBASIM             = /Applications/VisualBoyAdvance
FIND               = find
COPY               = cp -r
